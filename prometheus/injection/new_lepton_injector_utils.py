...
def make_new_LI_injection(
    ...
    materials_file = 'earthparams/materials/'
    earth_model_file = 'earthparams/densities/PREM.dat'
    
    earth = LI.detector.EarthModel()
    earth.LoadMaterialModel(materials_file)
    earth.LoadEarthModel(earth_model_file)
